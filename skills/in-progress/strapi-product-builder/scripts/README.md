...
- `validate-spec.ts` — sanity-check a finished `06-build-spec.md`: every content type referenced in the route tree exists, every env var is documented, every milestone has a "done when".
