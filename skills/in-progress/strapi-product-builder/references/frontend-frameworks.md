...
| **Astro** | Content-heavy / mostly-static sites (marketing, blogs, docs) | `npm create astro@latest` | `src/pages/` (file-based) | `PUBLIC_` | **`add-page`** (Astro-only — only recommend it on this path) |
